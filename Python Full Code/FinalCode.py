...
ser1 = serial.Serial('/dev/ttyACM1', 57600, timeout = 1) # $ ls /dev/tty* to find arduino port
ser2 = serial.Serial('/dev/ttyACM0', 57600, timeout = 1)
time.sleep(2)
